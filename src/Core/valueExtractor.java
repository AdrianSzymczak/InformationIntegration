...
public class valueExtractor {
    ...
    public List<List<String>> getValues(List<List<String>> imf, List<List<String>> wefd,
        ...
        for (int i = 1; i < imf.size(); i++) {
            ...
            String year1983 = rowReaded.get(12);
            String year1984 = rowReaded.get(13);
            String year1985 = rowReaded.get(14);
            String year1986 = rowReaded.get(15);
            String year1987 = rowReaded.get(16);
            String year1988 = rowReaded.get(17);
            String year1989 = rowReaded.get(18);
            String year1990 = rowReaded.get(19);
            String year1991 = rowReaded.get(20);
            String year1992 = rowReaded.get(21);
            String year1993 = rowReaded.get(22);
            String year1994 = rowReaded.get(23);
            String year1995 = rowReaded.get(24);
            String year1996 = rowReaded.get(25);
            String year1997 = rowReaded.get(26);
            String year1998 = rowReaded.get(27);
            String year1999 = rowReaded.get(28);
            String year2000 = rowReaded.get(29);
            String year2001 = rowReaded.get(30);
            String year2002 = rowReaded.get(31);
            String year2003 = rowReaded.get(32);
            String year2004 = rowReaded.get(33);
            String year2005 = rowReaded.get(34);
            String year2006 = rowReaded.get(35);
            String year2007 = rowReaded.get(36);
            String year2008 = rowReaded.get(37);
            String year2009 = rowReaded.get(38);
            String year2010 = rowReaded.get(39);
            String year2011 = rowReaded.get(40);
            String year2012 = rowReaded.get(41);
            String year2013 = rowReaded.get(42);
            String year2014 = rowReaded.get(43);
            String year2015 = rowReaded.get(44);
            String year2016 = rowReaded.get(45);
            String year2017 = rowReaded.get(46);
            String year2018 = rowReaded.get(47);
